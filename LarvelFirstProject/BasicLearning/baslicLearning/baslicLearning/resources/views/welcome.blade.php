  ...
  <body>
    ...
    <div class="jon d-flex bg-dark flex-column flex-lg-row align-items-center  bg-white border-bottom box-shadow" style="display:flex;justify-content:space-between">
      ...
      <nav class="my-2 d-flex ">
        <a class="p-2 nav-item" href="{{ route('about-us') }}">About us</a>
        <a class="p-2 nav-item" href="#">Enterprise</a>
        <a class="p-2 nav-item" href="#">Support</a>
        <a class="p-2 nav-item" href="#">Pricing</a>
      </nav>
      ...
      <footer class="pt-4 my-md-5 text-center border-top">
        <div class="row">
